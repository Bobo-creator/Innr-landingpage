      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-8 text-center">
        ...
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="order-2 lg:order-1">
            <h3 className="text-2xl font-bold text-slate-900 mb-6">Join the Waitlist</h3>
          ...
          <div className="order-1 lg:order-2">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl border-2 border-slate-200 p-6 shadow-lg">
                  ...
                  {topSchools.map((school, index) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <span className="text-2xl">{school.medal}</span>
                        <div>
                      ...
                      <div className="text-right">
                        <span className="text-lg font-black text-innr-red">#{index + 1}</span>
                        {index === 0 && (
